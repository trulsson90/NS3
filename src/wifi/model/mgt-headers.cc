...
void
MgtProbeResponseHeader::SetTime(uint64_t nodeTimer)
{

	 m_nodeTimer = nodeTimer;
}
uint64_t
MgtProbeResponseHeader::GetTime(void) const
{
	return m_nodeTimer;
}
...
MgtProbeResponseHeader::Serialize (Buffer::Iterator start) const
{
  ...
  i.WriteHtolsbU64(m_nodeTimer);//NodeTime
